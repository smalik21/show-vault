...
import { CardPropsType, MoviesPagePropsType } from "@/types/propTypes";
...
const MoviesPage = ({
  ...
  const fetchNewData = useCallback(
    async (pageNumber: number) => {
      const newData = await GetPopularMovie(pageNumber);
      setCardData(TransformPopularData(newData, "movie"));
  ...
  return (
    <div className={styles.moviesPage}>
      <SectionHeader title="Popular Movies"></SectionHeader>
